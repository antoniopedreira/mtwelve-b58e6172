...
export function ContractDetailDialog({
  ...
  const paidTotal = data?.installments
            ...
            <div className="p-6 space-y-6">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-lg">
                      {data.contract.clients?.name || "Cliente"}
                    </h3>
                    <p className="text-sm text-muted-foreground">
                      {data.contract.clients?.school || "Sem clube"}
                    </p>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <div className="p-4 rounded-lg bg-amber-500/5 border border-amber-500/20">
                  ...
                  <p className="font-bold text-xl text-amber-600">
                    {formatCurrency(totalValue - paidTotal)}
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="w-full bg-muted rounded-full h-2 overflow-hidden">
                  <div
                    className="bg-[#E8BD27] h-2 rounded-full transition-all"
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              desfeita e todas as parcelas e comissões serão removidas.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
