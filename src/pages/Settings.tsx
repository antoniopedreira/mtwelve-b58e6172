      ...
      <div className="space-y-6">
        ...
        <div className="p-6 rounded-xl bg-card border border-border/50 text-center">
          ...
          <p className="text-sm text-muted-foreground mb-4">
            Integrações com WhatsApp, Google Calendar e mais
          </p>
          {/* TODO: Supabase Integration - OAuth and third-party integrations */}
          <Button variant="outline" disabled>Ver Integrações</Button>
        </div>
      </div>
